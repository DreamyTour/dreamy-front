// MapLibre instances intentionally retain stable lifecycle refs.
// biome-ignore-all lint/correctness/useExhaustiveDependencies: Recreating map instances from callback props resets the active map.
// biome-ignore-all lint/a11y/noSvgWithoutTitle: The compass icon is labelled by its parent button.
"use client";
...
function CompassButton({ onClick }: { onClick: () => void }) {
	...
	return (
		<ControlButton onClick={onClick} label="Reset bearing to north">
			...
			>
				<path d="M12 2L16 12H12V2Z" className="fill-secondary" />
				<path d="M12 2L8 12H12V2Z" className="fill-secondary/60" />
